...
#releveling covid_change
el_pew$covid_change <- factor(el_pew$covid_change, levels = c("Not at all", "Not too much", "A fair amount", "A great deal"))
...
The items addressed in these report are: 
