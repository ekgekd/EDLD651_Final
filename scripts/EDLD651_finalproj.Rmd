...
```{r SimoneRegressionsprep, include=FALSE}
...
```{r SimoneChunkCleaning2, include=FALSE}
...
```{r, echo=FALSE, warning=FALSE, fig.cap="Predictions of National Unity by Family Closeness"}
log_table
```
